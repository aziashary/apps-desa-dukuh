...
@endforeach
  ...
  <main id="main">
    ...
    <section id="about" class="about section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Tentang Kami</h2>
          <h3>Tentang Desa<span> Dukuh<span>.</span></span></h3>
        </div>
    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Dokumentasi</h2>
          <h3>Galeri Desa <span>Dukuh</span></h3>
        </div>
    ...
    {{-- <section id="Aparaturdesa" class="team ">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Aparatur Desa</h2>
          <h3>Perangkat Desa <span>Dukuh</span></h3>
        </div>
    ...
    <section id="struktur" class="team">
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <h3>Struktur Organisasi Desa <span>Dukuh</span></h3>
        </div>

        <div class="row">
          <div class="col-lg-12" data-aos="fade-right" data-aos-delay="100">
            <img src="{{ asset ('template/foto/struktur.png') }}" class="img-fluid" alt="">
          </div>
        </div>
    ...
    <section id="contact" class="contact section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-6 ">
          <div class="mapouter"><div class="gmap_canvas"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d294.600399703178!2d106.65312771106076!3d-6.565191986760249!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69db934856ddd3%3A0x49eef75413443071!2sKANTOR%20KEPALA%20DESA%20DUKUH!5e0!3m2!1sid!2sid!4v1766093388976!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe><a href="https://piratebay-proxys.com/">Piratebay</a></div><style>.mapouter{position:relative;text-align:right;width:100%;height:400px;}.gmap_canvas {overflow:hidden;background:none!important;width:100%;height:400px;}.gmap_iframe {height:400px!important;}</style></div>
        </div>
  ...
  <footer id="footer">
    ...
    <div class="container py-4">
      <div class="copyright">
        &copy; Copyright <strong><span>Dukuh</span></strong>. All Rights Reserved
      </div>
    </div>
  </footer><!-- End Footer -->
